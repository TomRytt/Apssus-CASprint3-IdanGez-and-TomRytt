...
function GetBookFromGoogle(val) {
	return axios
...
function addBook(book) {
	const newBook = {
		...
		subtitle: book.volumeInfo.subtitle || 'a very nice book',
		authors: [...book.volumeInfo.authors] || 'god himself',
		publishedDate: book.volumeInfo.publishedDate || '1948',
		description:
			book.volumeInfo.description ||
			'no one read this book ever so no one knows',
		pageCount: book.volumeInfo.pageCount || utilService.makePagesCount(),
		categories: [...book.volumeInfo.categories] || 'Global',
		thumbnail:
			book.volumeInfo.imageLinks.smallThumbnail ||
			'https://www.buckinghambooks.com/static/basic_cms_store2/img/CoverNotFound2.jpg',
		language: book.volumeInfo.language || 'Jybrish',
		listPrice: {
			amount: utilService.makePrice(),
			currencyCode: 'USD',
			isOnSale: false,
		},
		reviews: [],
